...
class UnauthenticatedUserCrewTestCase(TestCase):
    def setUp(self):
        ...
        sample_crew()
        self.flights = sample_flight(airplane_type="New test crew type")
...
class AuthenticatedUserCrewTestCase(TestCase):
    ...
    def test_authenticated_crew_list(self):
        sample_crew(airplane_type="crew airplane type 2")

        sample_crew(airplane_type="crew airplane type 3")
        response = self.client.get(CREW_URL)
